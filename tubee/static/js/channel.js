...
let load_action_context = (data) => {
  ...
  switch (data.action_type) {
    case "Notification":
      ...
      edit_modal.find("#notification-url_title").val(data.details.url_title);
      edit_modal.find("#notification-image_url").val(data.details.image_url);
      break;
    case "Playlist":
      edit_modal.find("#playlist-playlist_id").val(data.details.playlist_id);
      break;
    case "Download":
